...
namespace CodrApp
{
    public partial class Snippets : Form
    {
        ...
        private void InitHotkeys()
        {
            ...
            GestorDeHotKeys.AddHotKey(this, OpenSearch, Keys.F, true);
            ...
            GestorDeHotKeys.AddHotKey(this, CloseSearch, Keys.Escape);
        ...
        private void OpenSearch()
        {
            ...
            GestorDePesquisas.SearchBox = TxtSearch;
            GestorDePesquisas.TextArea = TextArea;
            ...
            if (!SearchIsOpen)
            {
                ...
                InvokeIfNeeded(delegate ()
                {
                    ...
                    TxtSearch.Text = GestorDePesquisas.LastSearch;
                    TxtSearch.Focus();
                    TxtSearch.SelectAll();
                });
            }
        ...
        {
            GestorDePesquisas.Find(false, false);
        }
        private void BtnNextSearch_Click(object sender, EventArgs e)
        {
            GestorDePesquisas.Find(true, false);
        }
        private void TxtSearch_TextChanged(object sender, EventArgs e)
        {
            GestorDePesquisas.Find(true, true);
        }

        private void TxtSearch_KeyDown(object sender, KeyEventArgs e)
        {
            if (GestorDeHotKeys.IsHotkey(e, Keys.Enter))
            {
                GestorDePesquisas.Find(true, false);
            }
            if (GestorDeHotKeys.IsHotkey(e, Keys.Enter, true) || GestorDeHotKeys.IsHotkey(e, Keys.Enter, false, true))
            {
                GestorDePesquisas.Find(false, false);
            }
        }
        ...
        private void buttonNota_Click(object sender, EventArgs e)
        {
            try
            {
                string Idcategoria = ClassCategories.InserirCategoria(comboBoxCategoria.Text);
