public class Projeto
    {
        ...
        {
            string descricao = String.Format("Descrição: {0}", this.Descricao);
        ...
        internal bool ActivoNosProximosXMeses(int numeroMeses)
        {
            bool ok = false;

            //V1
            if (this.Activo() &&
                this.DataFim <= DateTime.Today.AddMonths(numeroMeses))
            {
                ok = true;
            }
        ...
        internal bool Activo()
        {
            ...
            //V1
            if (this.DataInicio <= DateTime.Today &&
                this.DataFim >= DateTime.Today)
            {
                ok = true;
            }
