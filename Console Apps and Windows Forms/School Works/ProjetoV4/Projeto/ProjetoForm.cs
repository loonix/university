...
namespace ExemploProjeto
{
    public partial class ProjetoForm : Form
    {
        ...
        private bool DadosValidos()
        {
            ...
            {
                //MessageBox.Show(Properties.Resources.MESSAGE_ID_PROJETO_INVALIDO);
                this.errorProviderProjeto.SetError(this.descricaoTextBox, Properties.Resources.MESSAGE_CLIENTE_INVALIDO);
                ok = false;
            }
        ...
        private void CarregarProjeto()
        {
            ...
            if (projeto == null)
            {
                ...
                //IGUAL
                MessageBox.Show(GlobalDLL.GlobalTexto.Format(Properties.Resources.MESSAGE_PROJETO_NAO_EXISTE, idProjeto, erro));
            }
            else
            {
