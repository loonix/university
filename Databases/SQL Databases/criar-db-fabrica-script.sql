...
select count(*) as numero_enc from Encomendas where YEAR(data_enc) = 2020
...
-- Qual o preço da Quantidade de produto superior à média.
...
-- Lista de fornecedores e produtos por eles fornecidos.
...
-- Lista de todas as encomendas efetuadas em 2020 ordenadas pelo número de cliente e incluindo as datas e o nome dos produtos encomendados.
